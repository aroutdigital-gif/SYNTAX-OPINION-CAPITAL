...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section id="contact" className="cta shell"><div><span>05 / CONNECT</span><h2>Ready to decode<br/><em>the market?</em></h2><p>Gabung ke ekosistem Syntax Opinion Capital dan bangun proses trading yang lebih terstruktur.</p></div><div className="ctaActions"><a className="primary" href="https://wa.me/6280000000000" target="_blank">WhatsApp Community <Send size={17}/></a><a className="secondary" href="https://t.me/" target="_blank">Telegram <ArrowUpRight size={17}/></a><a className="secondary" href="https://www.instagram.com/" target="_blank"><Instagram size={17}/> Instagram</a></div></section>
